...
if ($valor >= 1) {
  echo "Error";
    ...
    mysqli_query($conn, "UPDATE examen1 SET hisP='".$jsonObj->hisP."', hi1='".$jsonObj->xxx0."', hi2='".$jsonObj->xxx1."', hi3='".$jsonObj->xxx2."', hi4='".$jsonObj->xxx3."', hi5='".$jsonObj->xxx4."', hi6='".$jsonObj->xxx5."', hi7='".$jsonObj->xxx6."', hi8='".$jsonObj->xxx7."', hi9='".$jsonObj->xxx8."', hi10='".$jsonObj->xxx9."', hi11='".$jsonObj->xxx10."' WHERE nombre= '".$jsonObj->nom."' AND apellidos= '".$jsonObj->ape."'");
}
